...
import { FundingID, PeriodYYYYMM, YYYYMM } from "../types/types";
...
export type FundingEventJSON = FundingEventState;

export interface FundingManagerJSON {
  currency: string;
  fundingEvents: FundingEventJSON[];
  period: PeriodYYYYMM;
}
