// components/ChartGrossMarginTrend.tsx
...
interface ChartGrossMarginTrendProps {
...
const ChartGrossMarginTrend: React.FC<ChartGrossMarginTrendProps> = ({ data }) => {
  ...
  const layout: Partial<Plotly.Layout> = useMemo(() => {
    return {
      ...
      yaxis: {
        title: { text: "Gross Margin (%)", standoff: 40 },
        showgrid: true,
        zeroline: true,
        zerolinecolor: "#444",
        gridcolor: theme.colors.secondaryBackground,
...
export default ChartGrossMarginTrend;
