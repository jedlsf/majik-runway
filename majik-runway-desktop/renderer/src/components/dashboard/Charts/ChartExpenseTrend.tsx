// components/ChartExpenseTrend.tsx
...
interface ChartExpenseTrendProps {
...
const ChartExpenseTrend: React.FC<ChartExpenseTrendProps> = ({ data }) => {
...
export default ChartExpenseTrend;
